...
echo "=== MXD Library GKE Small Stop Script ==="
echo "Project ID: $PROJECT_ID"
echo "Cluster: $CLUSTER_NAME"
echo "Region: $REGION"
echo "Environment: $ENVIRONMENT"
echo "NOTE: This is for the quota-optimized small deployment"
echo
...
echo "Stopping MXD small application deployment..."
kubectl scale deployment mxd-enterprise-gke-small --replicas=0 -n mxd-$ENVIRONMENT || echo "Deployment not found or already scaled down"
...
echo "kubectl scale deployment mxd-enterprise-gke-small --replicas=2 -n mxd-$ENVIRONMENT"
...
echo "bash scripts/clean-gke-small.sh $PROJECT_ID $CLUSTER_NAME $REGION $ENVIRONMENT"
