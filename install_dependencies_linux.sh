...
install_system_deps() {
    sudo apt-get update
    sudo apt-get install -y build-essential cmake pkg-config libssl-dev libsodium-dev libgmp-dev libc-bin libcjson-dev libcurl4-openssl-dev librocksdb-dev libminiupnpc-dev libmicrohttpd-dev
